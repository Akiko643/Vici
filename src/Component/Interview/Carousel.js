...
const Carousel = ({ slides }) => {
    ...
    const mobileHandle = useSwipeable({
    ...
    return (
        <div className="carousel-container mt-60" {...mobileHandle}>
            <img src={leftIcon} className="left-arrow" onClick={prevSlide} />
            <img src={rightIcon} className="right-arrow" onClick={nextSlide} />
