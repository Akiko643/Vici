...
export const SuggestBlog = ({ title, imgsrc, publisher, date, publisherProfile }) => {
    return (
        <div className='flex flex-col w-250 h-330 bradius-10 b-white'>
            <img
                ...
                alt='blog'
            />
                <p className='fs-12 c-seablue mt-10'>#Good to know</p>
                <p className='fs-24 mt-15'>{title}</p>
                <div className='flex mt-13'>
                    <div className='flex'> {
                        publisherProfile ? (
                            ...
                            <div className='h-15 w-15 bradius-7.5 b-whitegray '></div>
                        )}
                        <p className='c-default fs-13 ml-5'>
                            {publisher ? publisher : 'Publisher name'}
                        </p>
                    </div>
                    <p className='c-default fs-13 ml-10'>{date ? date : 'MM/DD/YYYY'}</p>
                </div>
        </div>
    );
}
