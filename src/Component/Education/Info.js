        ...
        <div className='flex-col info-container'>
            ...
            <div className='flex'>
                <div className='ma-10 flex flex-col'>
                    <ul className='fs-20 lh-20 list-style-none pa-20'>
                        ...
                        </li>
                        {
                            chapters.map((chapter, index) => {
                                return (
                                    <li className={`c-default pb-10 bb-border-1 w-200 ma-4 pt-10 ${chapterIndex == index && 'active-chapter'} pointer`} onClick={() => setChapterIndex(index)}>
                                        {chapter.header}
                                    </li>
                                );
                            })
                    ...
                    <img src={Welcome} className='svg_images'/>
                    <img src={Location} className='svg_images'/>
                </div>
